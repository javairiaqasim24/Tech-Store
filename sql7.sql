...
CREATE TABLE `customer_returns` (
  ...
  KEY `product_id` (`product_id`),
  CONSTRAINT `customer_returns_ibfk_1` FOREIGN KEY (`bill_detail_id`) REFERENCES `customer_bill_details` (`Bill_detail_ID`),
  CONSTRAINT `customer_returns_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `products` (`product_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `supplier_returns` (
  ...
  KEY `product_id` (`product_id`),
  CONSTRAINT `supplier_returns_ibfk_1` FOREIGN KEY (`supplier_bill_detail_id`) REFERENCES `supplier_bill_details` (`s_Bill_detail_ID`),
  CONSTRAINT `supplier_returns_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `products` (`product_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-07-01 22:03:49
