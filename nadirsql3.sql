...
INSERT INTO `batch_details` VALUES (14,8,21,1000,40);
...
INSERT INTO `inventory` VALUES (24,14,85000,20),(25,15,65000,20),(26,16,2500,10),(27,17,32000,1),(28,18,8000,6),(29,19,18000,20),(30,20,15000,0),(31,21,2000,60),(32,22,3500,20),(33,23,95000,20);
...
INSERT INTO `supplier_bill_details` VALUES (5,18,21,40);
...
INSERT INTO `supplierbills` VALUES (18,3,'2025-07-06',1000,8,1000,'Paid');
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `trg_set_status_paid` BEFORE UPDATE ON `supplierbills` FOR EACH ROW BEGIN
...
INSERT INTO `supplierpricerecord` VALUES (9,3,18,'2025-07-06',500.00,'Initial Payment');
...
-- Dump completed on 2025-07-06 21:16:47
