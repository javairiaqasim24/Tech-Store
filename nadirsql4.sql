...
INSERT INTO `batch_details` VALUES (14,8,21,1000,40),(15,9,26,40000,2),(16,6,16,45454,200),(17,8,24,343443,43),(18,7,17,40000,2000),(19,9,16,32432,300),(20,7,22,3443434,2000),(21,10,23,1212,2);
...
INSERT INTO `inventory` VALUES (24,14,85000,20),(25,15,65000,30),(26,16,3453543,510),(27,17,333333,2001),(28,18,8000,6),(29,19,18000,20),(30,20,15000,0),(31,21,2000,59),(32,22,122,2020),(33,23,213123,22),(34,24,345555555,256),(35,26,80000,2);
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `trg_manual_inventory_adjustment` AFTER UPDATE ON `inventory` FOR EACH ROW BEGIN
  -- Check if quantity_in_stock has changed
...
INSERT INTO `supplier_bill_details` VALUES (5,18,21,40),(6,19,26,2),(7,20,16,200),(8,18,24,43),(9,21,17,2000),(10,19,16,300),(11,21,22,2000),(12,22,23,2);
...
INSERT INTO `supplier_returns` VALUES (2,5,21,'2025-07-07',NULL,1,'Refunded',0,'LGMX3-3001');
...
INSERT INTO `supplierbills` VALUES (18,3,'2025-07-06',40000,8,1000,'Due'),(19,3,'2025-07-07',70000,9,70000,'Paid'),(20,4,'2025-07-07',40000,6,20000,'Due'),(21,2,'2025-07-07',100000,7,90000,'Due'),(22,4,'2025-07-07',20000,10,16000,'Due');
...
INSERT INTO `supplierpricerecord` VALUES (9,3,18,'2025-07-06',500.00,'Initial Payment'),(11,3,19,'2025-07-07',30000.00,'Initial Payment'),(12,3,19,'2025-07-07',10000.00,'paid'),(13,4,20,'2025-07-07',20000.00,'Initial Payment'),(14,3,18,'2025-07-07',1000.00,'Initial Payment'),(15,2,21,'2025-07-07',50000.00,'Initial Payment'),(16,3,19,'2025-07-07',20000.00,'cxd'),(17,2,21,'2025-07-07',40000.00,'Initial Payment'),(18,3,19,'2025-07-07',10000.00,'paid'),(19,3,19,'2025-07-07',10000.00,'fcvfg'),(20,4,22,'2025-07-07',10000.00,'Initial Payment'),(21,4,22,'2025-07-07',6000.00,'tyu');
...
-- Dump completed on 2025-07-07 19:00:28
